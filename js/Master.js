$(document).ready(function () {
  ...
  $("a[class*=recebeImagem]").each(function () {
    ...
    if (
      ...
      $(this).prepend(
        '<img src="./images/icons/icon-excel.svg" alt="' + titulo + '">'
      );
    } else if (titulo.indexOf("áudio") != -1 || titulo.indexOf("audio") != -1) {
      $(this).prepend(
        '<img src="./images/icons/icon-audio.svg" alt="' + titulo + '">'
      );
    } else if (
      titulo.indexOf("apresentação") != -1 ||
      titulo.indexOf("presentation") != -1 ||
      titulo.indexOf("release") != -1 ||
      titulo.indexOf("resultados") != -1 ||
      titulo.indexOf("results") != -1
    ) {
      $(this).prepend(
        '<img src="./images/icons/icon-resultados.svg" alt="' + titulo + '">'
      );
    } else if (titulo.indexOf("video") != -1 || titulo.indexOf("vídeo") != -1) {
      $(this).prepend(
        '<img src="./images/icons/icon-play.svg" alt="' + titulo + '">'
      );
    } else {
      $(this).prepend(
        '<img src="./images/icons/icon-pdf.svg" alt="' + titulo + '">'
      );
    }
  });
...
function setCookie() {
  localStorage.setItem("cookiePoliticas", "saneago");
